...
#import "SCameraGroupSelectCell.h"

static NSString *groupSelectCellId = @"group_select_Cell_ID";

@interface SCameraGroupSelectTableView () <UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong) SCameraGroupSelectCell *groupSelectCell;

@end

@implementation SCameraGroupSelectTableView
...
- (void)registCell {
    ...
    [self registerClass:[SCameraGroupSelectCell class] forCellReuseIdentifier:groupSelectCellId];
}
